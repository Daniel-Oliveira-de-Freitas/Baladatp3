...
public class MainController implements Initializable {
	...
	public void leituraCliente() {
		...
		double credito;
		try {
		if(!Main.arquivoCliente().exists()) {
			Main.arquivoCliente().createNewFile();
		}
	...
	public void leituraProduto() {
		...
		try {
			if(!Main.arquivoProduto().exists()) {
				Main.arquivoProduto().createNewFile();
			}
	...
	public void leituraConsumo() {
		...
		int quantidade;
			...
			try {
				if(!Main.arquivoConsumo().exists()) {
					Main.arquivoConsumo().createNewFile();
				}
